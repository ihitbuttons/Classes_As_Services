...
class Example_Class implements Example_Interface
{
    ...
    public function exampleExternalMethod ($argumentArray)
    {
        ...
        if ($this->examplePrivateMethod()) {
            $returnValue = ["number" => $numberAsString, "string" => $string];
        } else {
            $this->logError(__METHOD__, "Value was false!");
        }
    ...
    private function examplePrivateMethod ()
    {
        $this->logInfo(__METHOD__, "Called.");
